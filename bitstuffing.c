...
void printBitStuffingFrame();
void printBitDestuffingFrame();
void binaryToText(char binary[], char text[]);
void writeBitOutputToFile();
...
void writeBitOutputToFile()
{
    ...
    fprintf(fp,"==============================================================\n");
    fprintf(fp,"             BIT STUFFING AND DESTUFFING OUTPUT\n");
    fprintf(fp,"==============================================================\n");
    ...
    fprintf(fp,"\nStuffed Binary Message\n");
    fprintf(fp,"%s\n", stuffedFrame);

    fprintf(fp,"\nPPP Frame After Bit Stuffing\n\n");

    fprintf(fp,"01111110 | %s | %s | %s | %s | %s | %s | %s | 00000000 | 01111110\n",
            sourceIPBinary,
            destinationIPBinary,
            sourceMACBinary,
    ...
    fprintf(fp,"\nReceived Stuffed Binary Message\n");
    fprintf(fp,"%s\n", stuffedFrame);

    fprintf(fp,"\nPPP Frame After Bit Destuffing\n\n");
    ...
    printf("\nBit Stuffing output saved to output2.txt\n");
}
void bitStuffing(char input[], char output[])
{
    int i,j=0,count=0;
...
void printBitStuffingFrame()
{
    ...
    printf("01111110 | %s | %s | %s | %s | %s | %s | %s | 00000000 | 01111110\n",
            sourceIPBinary,
            destinationIPBinary,
            sourceMACBinary,
            destinationMACBinary,
...
void printBitDestuffingFrame()
{
    bitDestuffing(stuffedFrame,destuffedFrame);
    ...
    printf("\nDestuffed Binary Message\n");
    printf("%s\n",destuffedFrame);
        binaryToText(destuffedFrame, receivedMessage);
        printf("01111110 | %s | %s | %s | %s | %s | %s | %s | 00000000 | 01111110\n",
            sourceIPBinary,
            destinationIPBinary,
            sourceMACBinary,
...
void dataLinkLayer()
{
    ...
    /* Stuff the entire binary message */
    bitStuffing(binaryMessage, stuffedFrame);

    /* Sender */
    printBitStuffingFrame();

    /* Receiver */
    printBitDestuffingFrame();
