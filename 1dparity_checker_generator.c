...
char parityFrames[MAX_FRAMES][600];
...
void writeByteOutputToFile()
{
    ...
    for(i=0;i<frameCount;i++)
    {
        ...
        fprintf(fp,"01111110 11111111 00000011 00000000 01010111 %s 0000000000000000 01111110\n\n",
                stuffedFrames[i]);
...
void printPPPFrame(char data[])
{
    ...
    printf("11111111 ");
    printf("00000011 ");
    printf("00000000 %s ", protocolBinary);
    printf("%s ",data);
...
void byteStuffing()
{
    ...
    for(i=0;i<frameCount;i++)
    {
        ...
        for(j=0;j<strlen(frames[i]);j+=8)
        {
            ...
            if(strcmp(byte,"01111110")==0 || strcmp(byte,"01111101")==0)
            {
        ...
        printf("\nPPP Frame After Byte Stuffing\n\n");

        printPPPFrame(stuffedFrames[i]);
...
void byteDestuffing()
{
    ...
    for(i=0;i<frameCount;i++)
    {
        ...
        printPPPFrame(destuffedFrames[i]);
                printf("\n Original Message:\n");
                printf("01111110 ");
                printf("11111111 ");
                printf("00000011 ");
                printf("00000000 01010111 ");
